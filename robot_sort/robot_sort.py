class SortingRobot:
    ...
    def sort(self):
        ...
        """
        # this almost looks like an exercise on the Swift Playgrounds App on iPad... if you haven't used it,
        # it uses blocks almost identical to these to "move" a character around a "world" via squares by
        # using blocks to create algorithms/ practice algorithmic thinking.
