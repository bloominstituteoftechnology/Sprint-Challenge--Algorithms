class SortingRobot:
    ...
    def sort(self):
        ...
        # while the light is on --> unsorted, continue to sort
        while self.light_is_on():

            # To start the sort, swap None
            ...
            while self.can_move_right():
                ...
                # swap if item is greater or None
                if self.compare_item() == 1 or self.compare_item() == None:
                    self.swap_item()

            # After going right, need to get back left
