class SortingRobot:
    ...
    def sort(self):
        ...
        """
        # while the robot is moving right and can't move right anymore
        while self.can_move_right():
            ...
            self.move_right()
            # compare
            # if item is smaller (-1) or the same (0)
            ...
            # else 
                ...
                # move right
                self.move_right()
            # if reaching the end and light on
...
if __name__ == "__main__":
    ...
    l = [15, 41, 58, 49, 26, 4, 28, 8, 61, 60, 65, 21, 78, 14, 35, 90, 54, 5,
         ...
         29, 22, 98, 17, 48, 52, 67, 53, 74, 77, 37, 63, 31, 7, 75, 36, 89, 70,
         34, 79, 83, 13, 57, 86, 12, 56, 50, 55, 46]
